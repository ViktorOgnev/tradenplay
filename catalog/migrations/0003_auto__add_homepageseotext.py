...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomepageSeoText'
        db.create_table('catalog_homepageseotext', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('seo_text', self.gf('tinymce.models.HTMLField')(null=True, blank=True)),
        ))
        db.send_create_signal('catalog', ['HomepageSeoText'])


    def backwards(self, orm):
        # Deleting model 'HomepageSeoText'
        db.delete_table('catalog_homepageseotext')
