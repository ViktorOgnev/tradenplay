...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.cropping'
        db.add_column('products', 'cropping',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Category.cropping'
        db.add_column('categories', 'cropping',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Product.cropping'
        db.delete_column('products', 'cropping')

        # Deleting field 'Category.cropping'
        db.delete_column('categories', 'cropping')
