...
class CheckoutForm(forms.ModelForm):
    """ 
    Checkout form class to collect user 
    billing and shipping information for placing an order
    """
    def __init__(self, *args, **kwargs):
        ...
        self.fields['shipping_state'].widget.attrs['size'] = '10'
        self.fields['shipping_state'].widget.attrs['size'] = '10'
        self.fields['shipping_zip'].widget.attrs['size'] = '8'
        
        self.fields['billing_state'].widget.attrs['size'] = '10'
        self.fields['billing_state'].widget.attrs['size'] = '10'
        self.fields['billing_zip'].widget.attrs['size'] = '8'
    ...
    def clean_phone(self):
        ...
        if len(stripped_phone) < 10:
            raise forms.ValidationError('Enter a valid phone number with area code.(e.g.+38 555 555-5555)')
